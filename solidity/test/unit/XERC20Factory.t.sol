...
contract UnitDeploy is Base {
  ...
  function testRevertsWhenAddressIsTaken() public {
    ...
    vm.prank(_owner);
    _xerc20Factory.deployXERC20('Test', 'TST', 'injective-protocol', _limits, _limits, _minters);
  ...
  function testNotParallelArraysRevert() public {
    ...
    _xerc20Factory.deployXERC20('Test', 'TST', 'injective-protocol', _minterLimits, _empty, _minters);

    vm.expectRevert(IXERC20Factory.IXERC20Factory_InvalidLength.selector);
    _xerc20Factory.deployXERC20('Test', 'TST', 'injective-protocol', _empty, _burnerLimits, _minters);
  }
  ...
  function testDeployEmitsEvent() public {
    ...
    address _token =
      _xerc20Factory.getDeployed(keccak256(abi.encodePacked('Test', 'TST', 'injective-protocol', _owner)));
  ...
  function testLockboxEmitsEvent() public {
    ...
    address[] memory _minters = new address[](0);
    vm.prank(_owner);
    address _token = _xerc20Factory.deployXERC20('Test', 'TST', 'injective-protocol', _limits, _limits, _minters);
